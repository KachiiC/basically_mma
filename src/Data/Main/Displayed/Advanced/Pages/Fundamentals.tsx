...
export const GrapplingData = (
    <>
        ...
        <p>Like striking, high level (even world champion) grapplers don’t always transition well, 
...
export const GamePlanningData = (
    <>
        ...
        <p>
            Coaches will know what their fighters are capable of, so it’s up to them to prepare 
