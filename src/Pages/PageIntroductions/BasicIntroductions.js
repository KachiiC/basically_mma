...
export const WhatIsMMAIntroduction = (
    <>
        <p>
...
export const RulesOfMMAIntroduction = (
    <>
        <p>
            Most rule sets for mixed martial arts competitions have evolved since the early 
            days of UFC 1 and Vale Tudo. As the knowledge about fighting techniques spread 
            among fighters and spectators, it became clear that the original minimalist rule 
            systems needed to be amended.In order to get the sport sanctioned by atletic 
            comissions, promotions such as the UFC began to introduce more rules. As rules 
            evolved and regulations added, different branches of mixed martial arts have 
            emerged, with differences between the different rulesets dictating different 
            strategies.
        </p>
        <p>
            The main motivations for these rule changes were to protect the health of the 
            fighters. The stigma of "barbaric, no rules, fighting-to-the-death" matches would 
            prevent atletic comissions from sanctioning if rules were not implemented.The 
            framework of the <b>Unified Rules of Mixed Martial Arts</b> was proposed and agreed upon 
            by various athletic commissions in the 2000s and was unanimously adopted by the 
            Association of Boxing Commissions (ABC) on July 30, 2009.
        </p>
        <p>
