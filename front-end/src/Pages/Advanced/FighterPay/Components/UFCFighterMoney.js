...
const UFCFighterMoney = () => (
    <>
        <h4 className="site-title">UFC Fighters Pay</h4>
        <div className="site-block-content">
            ...
            <h6 className="site-title">Fight Night Pay and Bonuses</h6>
            <p>
            ...
            <h6 className="site-title">The Reebok Sponsorship Deal</h6>
            <p>
            ...
            <div className="site-row">
                <div className="fighter-pay-pros-cons">
                    <p>
